...
-- Corriger les permissions RLS pour améliorer la compatibilité avec les clients
ALTER TABLE addresses DROP POLICY IF EXISTS "Users can view their own address";
ALTER TABLE addresses DROP POLICY IF EXISTS "Users can update own address";
ALTER TABLE addresses DROP POLICY IF EXISTS "Users can insert their own address";
ALTER TABLE addresses DROP POLICY IF EXISTS "Users can delete their own address";
